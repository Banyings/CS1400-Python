...
english = input("Enter a sentence to be translated into Pirate English: ").lower()

clean = ''.join(ch for ch in english if ch not in string.punctuation)

english_list = clean.split()
pirate = ''
